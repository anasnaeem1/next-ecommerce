const LoginPage = () => {
  return (
    <div className="relative h-[calc(100vh-80px)] w-full bg-gray-50 overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute -top-20 -left-20 w-96 h-96 bg-gray-300/30 rounded-[60%] blur-md rotate-45"></div>
      <div className="absolute top-1/3 right-0 w-80 h-80 bg-gray-400/20 rounded-[50%] blur-lg rotate-12"></div>
      <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-gray-300/20 rounded-[55%] blur-md rotate-12"></div>
